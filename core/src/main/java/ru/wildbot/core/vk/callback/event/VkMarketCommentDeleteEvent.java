...
@AllArgsConstructor
public class VkMarketCommentDeleteEvent implements WildBotEvent<VkMarketCommentDeleteEvent> {
    @Getter @Setter private Integer groupId;
    @Getter @Setter private CallbackMarketCommentDelete marketCommentDelete;
}
