...
@AllArgsConstructor
public class VkGroupOfficersEditEvent implements WildBotEvent<VkGroupOfficersEditEvent> {
    @Getter @Setter private Integer groupId;
    @Getter @Setter private CallbackGroupOfficersEdit groupOfficersEdit;
}
