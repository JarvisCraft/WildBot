...
@AllArgsConstructor
public class VkGroupChangeSettingsEvent implements WildBotEvent<VkGroupChangeSettingsEvent> {
    @Getter @Setter private Integer groupId;
    @Getter @Setter private CallbackGroupChangeSettings groupChangeSettings;
}
