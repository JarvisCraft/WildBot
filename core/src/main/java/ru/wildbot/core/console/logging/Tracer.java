 ...
 * Also Lombok's annotation {@link Log4j2} is acceptable.
 */
@UtilityClass
@SuppressWarnings("unused")
public class Tracer {
    @NonNull @Getter @Setter private static Logger logger = LogManager.getLogger("WildBot");
    ...
    public void fatal(final Object... objects) {
        if (objects != null && logger.isFatalEnabled()) for (Object object : objects) {
            if (object instanceof Throwable) object = ExceptionUtils.getStackTrace((Throwable) object);
            logger.fatal(AnsiCodes.FG_RED + String.valueOf(object) + AnsiCodes.RESET);
        }
    }

    public void fatal(final Collection<Object> objects) {
        if (objects == null) return;
        fatal(objects.toArray());
    }

    public void fatal(final Collection<Object> objects, final Object... args) {
        if (objects != null && logger.isFatalEnabled()) for (Object object : objects) {
            if (object instanceof Throwable) object = ExceptionUtils.getStackTrace((Throwable) object);
            logger.fatal(AnsiCodes.FG_RED + String.valueOf(object) + AnsiCodes.RESET, args);
        }
    }

    public void fatalF(final Collection<Object> objects, final Object... args) {
        if (objects != null && logger.isFatalEnabled()) for (Object object : objects) logger
                .fatal(String.format(String.valueOf(object), args));
    }

    public void fatalP(Collection<Object> objects, final Object... args) {
        if (objects != null && logger.isFatalEnabled()) {
            objects = formatWithPlaceholders(objects, args);
            for (Object object : objects) {
                if (object instanceof Throwable) object = ExceptionUtils.getStackTrace((Throwable) object);
                logger.fatal(AnsiCodes.FG_RED + String.valueOf(object) + AnsiCodes.RESET, args);
    ...
    public void fatalP(final Collection<Object> objects, final Collection<Object> args) {
        fatalP(objects, args.toArray());
    }
    ...
    public void debugP(Collection<Object> objects, final Object... args) {
        if (objects != null && logger.isDebugEnabled()) {
            objects = formatWithPlaceholders(objects, args);
            for (Object object : objects)
                logger.debug(AnsiCodes.FG_CYAN + String.valueOf(object) + AnsiCodes.RESET, args);
        }
    }
    ...
    public enum LogType {
        ...
        FATAL(Tracer::fatal, Tracer::fatal, Tracer::fatal, Tracer::fatalF, Tracer::fatalP, Tracer::fatalP),
         ...
         * @see Tracer#fatal(Collection, Object...)
         ...
         * @see Tracer#fatalF(Collection, Object...)
         ...
         * @see Tracer#fatalP(Collection, Object...)
         ...
         * @see Tracer#fatalP(Collection, Collection)
