...
import ru.wildbot.core.netty.transport.NettyTransportType;
import ru.wildbot.core.util.collection.Pair;
...
public class NettyServerCore implements WildBotManager {
    ...
    public void open(final String name, final ServerBootstrap bootstrap, final int port) {
    ...
    public boolean close(final String name, final int port) {
    ...
    public void startStandard(final String name, final ServerBootstrap bootstrap, final int port) {
    ...
    public void startHttp(final String name, final ServerBootstrap bootstrap, final int port) {
        open(name, bootstrap.channel(transportType.getServerSocketChannelClass())
                .option(ChannelOption.SO_BACKLOG, 128)
                .childOption(ChannelOption.SO_KEEPALIVE, true), port);
    }
